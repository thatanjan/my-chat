...
const messages = [
  ...
  {
    id: 6,
    content: "Hi team, don't forget about the meeting at 3 PM.",
    sender: 'Alice',
    timestamp: '09:45 AM',
    isSelf: false,
    chatId: 3,
  ...
  {
    id: 7,
    content: 'Thanks for the reminder, Alice!',
    sender: 'You',
    timestamp: '09:46 AM',
    isSelf: true,
    chatId: 3,
              ...
              <div>
                <div
                  className={cn(
                    ...
                    message.isSelf ? 'bg-blue-600' : 'bg-gray-700',
                  )}
                >
                  <p>{message.content}</p>
                </div>
            ...
            <div className='flex-grow'>
              <div className='flex justify-between items-center'>
                ...
                <span className='text-sm text-gray-400'>
                  {messages.find(m => m.chatId === chat.id)?.timestamp}
                </span>
              </div>
              <p
                className={cn(
